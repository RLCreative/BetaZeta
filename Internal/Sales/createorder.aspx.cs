...
public partial class sales_createorder : System.Web.UI.Page
{
    ...
    {    
        ...
        if (HttpContext.Current.Session["OrderHeaderID"] != null)
        {
            lblHeaderOrderID.Text = Session["OrderHeaderID"].ToString();
        }
    ...
    protected void AddToCart()
    {
        ...
        String insertCmd = "insert into SOPShoppingCart values (@GUID," +
         " @ItemNum, @Description, @Price, @Quantity)";
    ...
    {
        string currGuid = lblGuid.Text;
        string customerID = lblCustomerID.Text;      //Session["CustomerID"].ToString();
        string PONum = lblPONumber.Text;             //Session["PONumber"].ToString();
