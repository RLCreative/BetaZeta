<%@ Page Title="Track an order" Language="C#" MasterPageFile="~/internal/internal.master"
    AutoEventWireup="true" Inherits="retailers_trackorders" CodeBehind="trackorders.aspx.cs" %>
...
<table align="center">
    ...
    <tr>
        <td width="170"></td><td align="center"><asp:Button ID="btnSubmit" runat="server" Text="Track" Width="125"></asp:button></asp:TextBox></td>
    </tr>
    <tr>
        <td width="170"</td><td></td>
    </tr> 
